...
@endphp
<!-- row -->
<x-filament-support::grid :default="$columns['default'] ?? 12" :sm="$columns['sm'] ?? null" :md="$columns['md'] ?? null" :lg="$columns['lg'] ?? null" :xl="$columns['xl'] ?? null"
    :two-xl="$columns['2xl'] ?? null" :class="\Illuminate\Support\Arr::toCssClasses([
